// ==UserScript==
// @name         Gartic.io AUTO DRAW - Garticio Hacks - Best Gartic Cheat 2019 to 2020
...
// @updateURL    https://io-mods.com/mods/garticio.user.js
// @downloadURL  https://io-mods.com/mods/garticio.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://gartic.io/*
// @match        *iogames.space/*
...
//degisenkisimlar
$('.logo').append('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('.lastRooms').append('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('.advantagesLogin').html('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('.mobileHide').html('<div class="list1"></div>');
$('#content').prepend(''+this.st.imagelist+'');
...
} document.getElementsByClassName("containerForm")[0].prepend(styleSelect);

styleSelect.selectedIndex = GM_getValue("style");
styleSelect.onchange = function() { GM_setValue("style", styleSelect.selectedIndex); }

var chatInput = document.querySelectorAll('input[type=text]')[0];
...
document.getElementsByClassName("containerForm")[0].appendChild(stylerSelect);
